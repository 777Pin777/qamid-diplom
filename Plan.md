...
Процессор для среды разработки: Intel(R) Core(TM) i7-4770K CPU @ 3.50GHz

Оперативная память: 32,0 ГБ (доступно: 8,9 ГБ)
...
- Проведение автоматизированного тестирования - 28.04.2023

- Формирование отчета о тестировании - 03.05.2023
