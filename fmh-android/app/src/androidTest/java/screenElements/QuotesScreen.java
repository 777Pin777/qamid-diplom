...
public class QuotesScreen {
    ...
    public static ViewInteraction firstDescriptionOfQuoteValue = onView(withText("\"Идеальное устройство мира в моих глазах; где никто не оценивает, не осуждает, где говоришь и тебя слышат. Если страшно, тебя обнимут и возьмут за руку, а если холодно тебя согреют.” Юля Капис, волонтер"));
}
